...
void _HookOriFunction(void* func, void *hook, void **old)
{
    static void (*_OriMSHookFunction)(void *symbol, void *hook, void **old) = NULL;
    if (_OriMSHookFunction == NULL)
    {
        _OriMSHookFunction = dlsym(dlopen("/Library/Frameworks/CydiaSubstrate.framework/CydiaSubstrate", RTLD_LAZY), "MSHookFunction");
    }
    
    //
    if (_OriMSHookFunction)
    {
        _OriMSHookFunction(func, hook, old);
    }
    else
    {
        *old = NULL;
